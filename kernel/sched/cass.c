				    ...
				    int wake_flags)
{
	...
	/*
	 * Keep the vendor hook (OPLUS/MTK scheduling customizations) fully
	 * functional: let it override the target CPU first, and fall back to
	 * CASS only when the vendor code leaves the decision to us.
	 */
